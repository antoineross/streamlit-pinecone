...
with st.sidebar.container():
    ...
    openai_api_key =  st.text_input("OpenAI API Key", type="password") #st.secrets["OPENAI_API_KEY"]
    ...
    if data_source == "Upload File":
        ...
        vectordb = configure_vectordb_from_index(openai_api_key, index_name, namespace=namespace)
